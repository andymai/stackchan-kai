...
//!        `mind.affect.emotion`, sets `mind.autonomy.manual_until`.
//!     2. [`RemoteCommand`] — consumes IR-remote `(address, command)`
//!        pairs, looks them up in a user-supplied mapping table,
//!        sets emotion + autonomy.
...
//!     6. [`LowBatteryEmotion`] — reads `perception.battery_percent`
//!        + `perception.usb_power_present`, forces `Sleepy` below
...
//!
//! Empty phases today (slots reserved for v2.x): [`Perception`],
//! [`Cognition`], [`Speech`], [`Output`].
//!
//! [`Perception`]: crate::director::Phase::Perception
//! [`Cognition`]: crate::director::Phase::Cognition
//! [`Speech`]: crate::director::Phase::Speech
//! [`Output`]: crate::director::Phase::Output
